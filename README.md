...
3. (For Android platform only) Install Cordova: `npm install cordova -g`
4. (For Android platform only) Install Java JDK 8, Gradle and Android Studio (Android SDK at least level 16)
5. Change to project folder and run `yarn install`.
6. Run `yarn start`.
